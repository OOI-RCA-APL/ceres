...
if TYPE_CHECKING:
    from ceres._internal.utilities.typing import Stringy
...
def seq[T](value: T | Sequence[T], /) -> Sequence[T]:
    from ceres._internal.utilities.typing import is_sequence
...
def flatten[T](value: RecursiveIterable[T], /) -> Iterator[T]:
    from ceres._internal.utilities.typing import is_iterable
