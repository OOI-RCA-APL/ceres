    ...
    pub(crate) fn schema(&self) -> Schema {
        ...
        Schema {
            ...
            entity: match self {
                ...
                Self::Particles => Particle::NAME,
                Self::Alerts => Alert::NAME,
                Self::Logs => LogEntry::NAME,
            },
            python_module: match self {
                Self::Messages => "ceres.message",
                Self::Particles => "ceres.particle",
                Self::Alerts => "ceres.alert",
                Self::Logs => "ceres.logs",
            },
            fields: self.fields(),
            columns: match self {
...
pub struct Schema {
    ...
    pub name: &'static str,
    /// The entity struct's own name, which generated Python models take as the class
    /// name.
    pub entity: &'static str,
    /// The public Python module declaring the entity, which generated models import
    /// their forward references from and present under.
...
pub struct Computed {
    ...
    pub shape: Shape,
    /// The key's docstring in the generated Python filters.
    pub doc: &'static str,
}
