...
5. Go into `./dev/intro` and run `poetry install`. _This will install local dependencies and create a virtual environment._
6. Run `poetry shell` to enter the project's virtual environment. _This makes `ceres` available as a command._
